...
export const options = {
    stages: [
        { duration: '1s', target: 10 },  // Subir para 100 VUs em 1 minuto
        { duration: '2s', target: 20 },  // Subir para 200 VUs em 2 minutos
        { duration: '3s', target: 30 },  // Subir para 300 VUs em 3 minutos
        { duration: '2s', target: 40 },  // Subir para 400 VUs em 2 minutos
        { duration: '1s', target: 0 },    // Reduzir para 0 VUs em 1 minuto
    ],
    thresholds: {
...
export function handleSummary(data) {
    return {
        '../reports/result_getListUsersStressTest.html': htmlReport(data),  // Gera o relatório HTML na pasta reports
        '../reports/result_getListUsersStressTest.json': JSON.stringify(data),  // Gera o relatório JSON na pasta reports
    };
}
